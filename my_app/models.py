...
class Pdaq(models.Model):
    ...
    SD = models.CharField(max_length=128, verbose_name='SD卡', blank=True, null=True)
    INTERNET = models.CharField(max_length=128, verbose_name='网口速率', default='100M/s', null=True, blank=True)
    MODEL = models.CharField(max_length=128, verbose_name='模式', default='录像', blank=False, null=False)
